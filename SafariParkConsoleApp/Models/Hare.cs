namespace SafariParkConsoleApp.Models
{
    ...
    /// Hare class.
    /// </summary>
    public sealed class Hare : Rabbits
    {
        private readonly string color;

        /// <summary>
        /// Initializes a new instance of the <see cref="Hare"/> class.
        /// </summary>
       ...
       /// <param name="aWild">Wild or no.</param>
        ...
        public Hare(string aName, TimeSpan aLifeSpan, Continent aContinentHabitat, float aSpeed, float aLenghtOfTail, bool aWild, string aColor)
